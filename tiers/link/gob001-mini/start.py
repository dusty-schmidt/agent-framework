...
def start_backend():
    ...
    # Use conda run to activate environment and run python with correct module path
    cmd = ['conda', 'run', '-n', 'agentic-framework', 'python', '-m', 'uvicorn', 'backend.main:app', '--host', '0.0.0.0', '--port', '8001', '--reload']
